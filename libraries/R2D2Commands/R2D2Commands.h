...
#define TOGGLE_INTERFACE_ARM "BM_TIA"
#define ROTATE_INTERFACE_ARM "BM_SIA"

#define TOGGLE_GRIPPER_ARM "BM_TGA"
#define CONTROL_GRIPPER "BM_CGA"

#define TOGGLE_UTILITY_ARM_TOP "BM_TU1"
#define TOGGLE_UTILITY_ARM_DOWN "BM_TU2"