...
String PS3ControllerFootMac = "00:06:F7:57:78:18"; // Set this to your FOOT PS3 controller MAC address
String PS3ControllerDomeMAC = "00:06:F7:BE:CB:BA"; // Set to a secondary DOME PS3 controller MAC address (Optional)
...
void onInitPS3NavFoot()
{
  ...
  if (btAddress == PS3ControllerFootMac || btAddress == PS3ControllerBackupFootMac)
  {
    ...
    dfPlayerSerial.write(RIGHT_PAD_CON);
...
void onInitPS3NavDome()
{
  ...
  {
    dfPlayerSerial.write(LEFT_PAD_CON);
#ifdef SHADOW_DEBUG
